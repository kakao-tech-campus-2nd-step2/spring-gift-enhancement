...
values ('멤버', 'member@naver.com', 'password', 0, false);
insert into member(name, email, password, role, deleted)
values ('관리자', 'admin@naver.com', 'password', 1, false);

insert into product_category(name, description, color, image_url, deleted)
values ('디지털/가전', '가전설명', '#888888', '가전이미지', false);
insert into product_category(name, description, color, image_url, deleted)
values ('상품권', '상품권설명', '#123456', '상품권이미지', false);
insert into product_category(name, description, color, image_url, deleted)
values ('뷰티', '뷰티설명', '#777777', '뷰티이미지', false);
insert into product_category(name, description, color, image_url, deleted)
values ('식품', '식품설명', '#222222', '식품이미지', false);
