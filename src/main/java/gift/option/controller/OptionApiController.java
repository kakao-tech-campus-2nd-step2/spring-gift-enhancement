...
public class OptionApiController {
    ...
    @PostMapping
    public ApiResponseDto createOption(@RequestBody @Valid OptionRequestDto optionRequestDto,
    ...
    @GetMapping
    public ApiResponseDto readOptions() {
        return ApiResponseDto.succeed(optionService.selectOptions());
    }
}
