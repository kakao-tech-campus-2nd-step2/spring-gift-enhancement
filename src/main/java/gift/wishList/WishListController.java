...
public class WishListController {
    ...
    @PostMapping
    @Transactional
    public WishListResponse addWishes(@LoginUser User user, @RequestBody WishListRequest wishListDTO) {
    ...
    @GetMapping
    @Transactional
    public List<WishListResponse> getWishesByUser(@LoginUser User user) {
    ...
    @PutMapping("/{id}")
    @Transactional
    public WishListResponse updateWishesCount(@PathVariable long id, @RequestBody CountDTO count) {
        if (count.count == 0) {
    ...
    @DeleteMapping("/{id}")
    @Transactional
    public WishListResponse deleteWishes(@PathVariable long id) {
        wishListService.deleteByID(id);
        return null;
    }
    ...
    @GetMapping("/pages")
    @Transactional
    public ResponseEntity<Page<WishListResponse>> getWishListsPage(@LoginUser User user,
