...
public class ProductCreator {
    ...
    public void ProductCreator() {
        productService.createProduct(new CreateProduct("Product A", 1000, "image1.jpg", 1L));
        productService.createProduct(new CreateProduct("Product B", 1500, "image2.jpg", 2L));
        productService.createProduct(new CreateProduct("Product C", 2000, "image3.jpg", 3L));
