...
public class DatabaseLoader {
    ...
    public CommandLineRunner initData(ProductRepository repository, CategoryRepository categoryRepository) {
        return args -> {
            ...
            categoryRepository.save(new Category(6, "리빙/도서", "#6c95d1", "https://lh3.googleusercontent.com/proxy/xsIQupZPagSILU71LwcOmBv4BvStIWOnZuS1-vy_wsZqunSeuXtfJEDzd8Tpshyr1IbCoSRiw-3-BweYOThwoU-z2Eud1o9Fevnx46M9SIM5keznCps5uZOTOmO6agFuqhVA89QifFtJUyd30ybyWFYkqKo5VDC-", ""));
