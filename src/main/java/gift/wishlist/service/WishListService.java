...
public class WishListService {
    ...
    public List<WishListResponseDto> readWishProducts(long userId, PageInfoDto pageInfoDto) {
        ...
        var wishList = wishListRepository.findByUserProductUserId(userId, pageable);
    ...
    @Transactional
    public void deleteWishProduct(WishListIdDto wishListIdDto, long userId) {
    ...
    private void verifyDeleteOwnWishProduct(WishList wishProduct, long userId) {
        if (!wishProduct.getUserProduct().getUserId().equals(userId)) {
