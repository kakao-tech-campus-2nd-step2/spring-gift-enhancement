...
class CategoryRepositoryTest {
    ...
    void setUp() {
        ...
        categoryRepository.saveAll(List.of(
                new Category("카테고리1", "#000000", "category1.png", "카테고리1입니다."),
                new Category("카테고리2", "#111111", "category2.png", "카테고리2입니다."),
                new Category("카테고리3", "#222222", "category3.png", "카테고리3입니다.")
        ));
    }
    ...
    void addCategory() {
        //given
        Category category = new Category("카테고리4", "#333333", "category4.png", "카테고리4입니다.");
    ...
    void findCategory() {
        //given
        Category category = new Category("카테고리5", "#444444", "category5.png", "카테고리5입니다.");
    ...
    void updateCategory() {
        //given
        Category category = new Category("카테고리6", "#555555", "category6.png", "카테고리6입니다.");
        Category savedCategory = categoryRepository.save(category);
    ...
    void deleteCategory() {
        //given
        Category category = new Category("카테고리8", "#777777", "category8.png", "카테고리8입니다.");
        Category savedCategory = categoryRepository.save(category);
